...
const Chair = (props) =>  {
  ...
  const leatherTextureProps = useTexture({
    // map:"./textures/leather/Leather_Weave_005_basecolor.jpg",
    normalMap:"./textures/leather/Leather_Weave_005_normal.jpg",
    roughnessMap:"./textures/leather/Leather_Weave_005_roughness.jpg",
    aoMap:"./textures/leather/Leather_Weave_005_ambientOcclusion.jpg",
  });
